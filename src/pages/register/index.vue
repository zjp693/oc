<template>
  <view class="register-page">
    ...
    <button class="back-button" hover-class="button-hover" @click="handleBack" aria-label="返回">
      <view class="back-chevron" />
    </button>

    <view class="register-content">
      <view class="register-title-wrap">
        <image class="register-title" src="/static/login/register_title.png" mode="aspectFit" />
      ...
      <view class="register-form-panel">
        ...
        <view class="field-block confirm-block">
          <view class="password-field">
            ...
            />
            <button class="eye-button" hover-class="button-hover" @click="showConfirmPassword = !showConfirmPassword">
              <image
                class="eye-icon"
          ...
          <text class="error-text" :class="{ 'error-text-visible': confirmError }">{{ confirmError || '占位' }}</text>
        </view>

        <button class="submit-button" hover-class="button-hover" @click="handleSubmit">注册</button>
      </view>
    </view>
  </view>
</template>
